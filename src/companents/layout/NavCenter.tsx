...
import ShopModal from "@/pages/_companents/shopping";
...
function NavCenter() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await fetch("https://nt.softly.uz/api/front/products");
  ...
  return (
    <div>
      <div className="max-w-screen-xl mx-auto pt-6 flex justify-between items-center gap-4 px-4 md:px-12">
        <Link href="/">
        ...
        <div className="flex gap-6 items-center">
          ...
          >
            ...
            <p className="text-gray-800">Savatga</p>
          </div>
      ...
      <ShopModal savatModal={showCart} setSavatModal={setShowCart} />
